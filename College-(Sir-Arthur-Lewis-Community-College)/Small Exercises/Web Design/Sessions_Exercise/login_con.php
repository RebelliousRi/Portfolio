...
exit;
        ...
        echo ("<h3>Invalid username. <br><br> Are you sure you're a member of the Super Secret Web? <br><br> If you aren't youre in trouble because we will find you <br><br> :) </h3>");

    }

    else if ($pwd != $ValidUser["pwd"]) {

        echo ("<h3>Invalid password. <br><br> Are you sure you're a member of the Super Secret Web? <br><br> If you aren't youre in trouble because we will find you <br><br> :) </h3>");
